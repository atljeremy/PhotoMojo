...
public class CellLayout extends ViewGroup {
	...
	public CellLayout( Context context, AttributeSet attrs, int defStyle ) {
		...
		mCellPaddingV = a.getDimensionPixelSize( R.styleable.CellLayout_verticalPadding, 0 );

		mStartPadding = a.getDimensionPixelSize( R.styleable.CellLayout_cellStartPadding, 0 );
		mEndPadding = a.getDimensionPixelSize( R.styleable.CellLayout_cellEndPadding, 0 );
		mTopPadding = a.getDimensionPixelSize( R.styleable.CellLayout_cellTopPadding, 0 );
		mBottomPadding = a.getDimensionPixelSize( R.styleable.CellLayout_cellBottomPadding, 0 );
		mLayoutDirection = a.getInteger( R.styleable.CellLayout_layout_direction, 0 );
